...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-green-600 dark:bg-zinc-800">
        <flux:header container class="border-b border-zinc-200 bg-green-600 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <!-- Mobile Menu -->
        <flux:sidebar stashable sticky class="lg:hidden border-r border-zinc-200 bg-green-600 dark:border-zinc-700 dark:bg-zinc-900">
